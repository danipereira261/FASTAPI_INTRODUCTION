...
from schemas import StandardOutput, UserCreateInput, ErrorOutput, UserFavoriteAddInput, UserListOutput, DaySummaryOutput
...
async def user_delete(user_id: int, symbol: str):
    try:
